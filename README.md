...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/prettymaps-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14954&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/prettymaps-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `prettymaps` can be installed with:

```
conda install prettymaps
```

It is possible to list all of the versions of `prettymaps` available on your platform with:
